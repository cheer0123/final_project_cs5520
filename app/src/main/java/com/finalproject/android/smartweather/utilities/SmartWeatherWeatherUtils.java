...
public final class SmartWeatherWeatherUtils {

    private static final String LOG_TAG = SmartWeatherWeatherUtils.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!SmartWeatherPreferences.isMetric(context)) {
