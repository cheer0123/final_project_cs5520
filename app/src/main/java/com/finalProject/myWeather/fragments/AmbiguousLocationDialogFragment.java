...
import com.finalProject.myWeather.adapters.LocationsRecyclerAdapter;
...
public class AmbiguousLocationDialogFragment extends DialogFragment implements LocationsRecyclerAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_location_fragment_, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i = 0; i < cityListArray.length(); i++) {
                ...
                final float temperature = UnitConverter.convertTemperature(Float.parseFloat(mainObject.getString("temp")), sharedPreferences);
